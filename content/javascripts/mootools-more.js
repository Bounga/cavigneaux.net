...
// Load this file's selection again by visiting: http://mootools.net/more/1a90489c38c9d2b89abf8c1ea3b88a44 
// Or build this file again with packager using: packager build More/Date More/Request.JSONP More/Locale.fr-FR.Date
/*
---
copyrights:
...
Locale.addEvent("change",function(s){if(Locale.get("Date")){b(s);}}).fireEvent("change",Locale.getCurrent());})();Request.JSONP=new Class({Implements:[Chain,Events,Options],options:{onRequest:function(a){if(this.options.log&&window.console&&console.log){console.log("JSONP retrieving script with url:"+a);
